...
1. Takes a link (post, video, article).
2. Pulls out the actual claim(s) being made.
3. Checks if it's already been fact-checked before.
4. Searches trusted sources for context.
5. Gives you a verdict + reasoning + links.
...
- Text / article links: ~2–4 seconds
- Video links: ~5–8 seconds
- Repeat lookups: under 2 seconds
...
- Works on public content only.
- Not a replacement for professional fact-checkers — a fast first pass.
- Results are cached briefly so viral claims stay fresh.
